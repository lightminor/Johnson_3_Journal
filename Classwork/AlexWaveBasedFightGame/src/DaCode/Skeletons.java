...
public class Skeletons {
    ...
    public static int SkeletonHP = 30;
    public static int SkeletonCurrentHP = 30;
    public static int SkeletonDamageTaken = 0;
    ...
    public static int SkeletonGoldworth;      
    public static int SkeletonXPworth;        
    

    private int startX, startY, width = 35, height = 42;
    float SkhitboxX = this.Bx + 8f;
    float SkhitboxY = this.By + 8f;
    ...
    Skeletons(int a, int b) throws SlickException {
        ...
        SkhitboxX = this.getskhitboxX();

        SkhitboxY = this.getskhitboxY();

        rect = new Rectangle(SkhitboxX, SkhitboxY, width, height);
        ...
        SpriteSheet skeletonSS = new SpriteSheet("res/skeletonwspearsprites.jpg",
